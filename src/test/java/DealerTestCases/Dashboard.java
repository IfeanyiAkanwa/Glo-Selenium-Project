...
public class Dashboard extends TestBase { 
	...
	public void assertCardCountTest() throws InterruptedException {
		TestUtils.testTitle("Assert Card Count on Dealer Dashboard");
	    ...
	    TestUtils.assertSearchText("CSSSELECTOR", "a.navbar-brand", "DEALER");
		...
		String todayNewRegValString = getDriver().findElement(By.id("new_registration_today")).getText();
	    String reRegistrationTodayValString = getDriver().findElement(By.id("re_registration_today")).getText();
	    ...
	    getDriver().findElement(By.cssSelector(monthlyInactiveKitsB)).click();
	  	...
	  	try {
		    ...
		    testInfo.get().log(Status.INFO,"Total Agents <b>("+actualTotalAgents+")</b> equals to summation of Locked Out Agents <b>("+actualLockedOutAgent+")</b> and Unlocked Out Agents <b>("+actualUnlockedOutAgents+")</b>.");
		    	  ...
		    	  verificationErrors.append(e.toString());
		    	  String verificationErrorString = verificationErrors.toString();
		    	  testInfo.get().error("Locked Out and Unlocked Out Agents Summation is not equal to total agents");
		    	 testInfo.get().error(verificationErrorString);
		    }
	}
